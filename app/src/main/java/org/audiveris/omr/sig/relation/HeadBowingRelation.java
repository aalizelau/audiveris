//------------------------------------------------------------------------------------------------//
//                                                                                                //
//                               H e a d B o w i n g R e l a t i o n                              //
//                                                                                                //
//------------------------------------------------------------------------------------------------//
...
/**
 * Class <code>HeadBowingRelation</code> represents the relation between a note head and
 * a bowing indication (upbow or downbow).
 *
 * @author Hervé Bitteur
 */
@XmlRootElement(name = "head-bowing")
public class HeadBowingRelation
        extends AbstractConnection
{
    ...
    {
        final BowingInter bowing = (BowingInter) e.getEdgeTarget();

        bowing.checkAbnormal();
    }
    ...
    {
        return constants.bowingTargetCoeff.getValue();
    }
    ...
    private static class Constants
            extends ConstantSet
    {
        private final Constant.Ratio bowingTargetCoeff = new Constant.Ratio(
                2.0,
                "Supporting coeff for (target) bowing");
